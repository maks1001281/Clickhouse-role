...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/etc/ansible/roles/clickhouse/Python-3.10.0/coverage.info',
 'COVERAGE_REPORT': '/etc/ansible/roles/clickhouse/Python-3.10.0/lcov-report',
 ...
 'abs_builddir': '/etc/ansible/roles/clickhouse/Python-3.10.0',
 'abs_srcdir': '/etc/ansible/roles/clickhouse/Python-3.10.0',
